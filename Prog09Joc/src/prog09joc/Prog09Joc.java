...
// Atributs
        ...
        while (!partidaAcabada) {
            ...
            while (!partidaAcabada) {
                ...
                do {
                    ...
                    // el qual determinara si el moviment és vàlid
                    movimentFNOK = fb.moureA(posFNPossible);
                    if (movimentFNOK) {
                        ...
                        partida.insereixPosicio(fb.getPosicio(), idFitxaNegra);
                        movimentFNOK = true;
    ...
    public int calculaIndexColumna(String columna) {
        ...
        if (columna.equals("A")) return 0;
        else if (columna.equals("B")) return 1;
        else if (columna.equals("C")) return 2;
        else if (columna.equals("D")) return 3;
        else return 4;
